...
Import StuckValueFault and other packages that are used in this tutorial
...
![original](../../images/demos/stuck_value_fault/original.png)

## Define Fault

This example will utilize the `StuckValueFault` library to create an instance of the stuck value fault. The `StuckValueFault` expects the `params` variable to be equal to a dictionary containing the key `stuck_val`.
...
![delta](../../images/demos/stuck_value_fault/delta.png)
...
![comparison](../../images/demos/stuck_value_fault/comparison.png)