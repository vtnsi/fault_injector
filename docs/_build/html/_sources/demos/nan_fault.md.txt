...
Import NaNFault and other packages that are used in this tutorial
...
![original](../../images/demos/nan_fault/original.png)

## Define Fault

This example will utilize the `NaNFault` library to create an instance of the nan fault.
...
![delta](../../images/demos/nan_fault/delta.png)
...
![comparison](../../images/demos/nan_fault/comparison.png)
