...
import numpy as np
import pandas as pd
import fault_injector.fault_injector as fault_injector
...
class DataFrameFaultInjection():
    ...
    def inject_fault(self):
        ...
        for i in self.column_names:
            ...
            df_inject = fault_injector.FaultInjection(values=original_lst, start=self.start_val, stop=self.stop_val, increasing=1)
